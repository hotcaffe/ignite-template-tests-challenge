...
import { CreateTransfersStatementController } from "../modules/statements/useCases/createTransfersStatement/CreateTransfersStatementController";
import { ensureAuthenticated } from "../shared/infra/http/middlwares/ensureAuthenticated";

const statementRouter = Router();
const getBalanceController = new GetBalanceController();
const createStatementController = new CreateStatementController();
const createTransfersStatementController = new CreateTransfersStatementController();
...
statementRouter.post("/transfers/:user_id", createTransfersStatementController.execute);
